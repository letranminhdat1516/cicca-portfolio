...
async function main() {
  ...
  await prisma.profile.upsert({
    ...
    create: {
      ...
      classRole: 'Creative Developer & AI Engineer',
      roles: ['Creative Developer', 'Full-stack Engineer', 'AI Engineer', 'Problem Solver'],
      tagline: 'I build production AI agents, real-time systems, and full-stack web apps.',
      bio: 'Full-stack & AI developer. I ship production AI agents (Claude Agent SDK, RAG/pgvector), real-time systems, and full-stack web apps — from AI trading platforms to VAS-compliant ERP.',
      level: 42,
      rank: 'LEGENDARY',
      region: 'REMOTE',
